...
SHOTS = [
    ...
    (85.8, 89.6, 'yarn'), (89.6, 93.7, 'gasp'), (93.7, 97.5, 'stage'), (97.5, 99.3, 'noggin'), (99.3, 100.1, 'stage'),
    (100.1, 101.6, 'corn'), (101.6, 104.4, 'veal'), (104.4, 112.9, 'keepreal'), (112.9, 122.8, 'pillow'),
